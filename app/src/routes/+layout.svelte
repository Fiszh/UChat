...
<svelte:head>
    ...
    <meta property="og:title" content="UChat Twitch Chat Overlay Setup • uniiDev" />
    <meta name="twitter:title" content="UChat Twitch Chat Overlay Setup • uniiDev" />
    ...
    <meta name="twitter:image" content="https://cdn.unii.dev/uchat/twitter.png" />
	...
	<script type="application/ld+json">
		{
			...
			"sameAs": [
				...
				"https://discord.com/users/703639905691238490"
			]
		}
	</script>
</svelte:head>
