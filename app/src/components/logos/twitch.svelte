<!-- Taken from the 7TV Repo: https://github.com/SevenTV/SevenTV/blob/main/apps/website/src/components/icons/twitch-logo.svelte -->
...
>
    ...
    <path
        ...
        fill={brandColor ? "#8956FB" : "currentColor"}
    />
</svg>
